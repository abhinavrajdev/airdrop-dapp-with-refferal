async function ClaimAirdropRefer(reciept, referral, amount) {
  ...
  try {
    console.log(reciept, referral, amount);
    const result = await contract.ClaimAirdropRefer(reciept, referral, amount, {
      value: feeValue,
      gasLimit: 300000,
    });
    console.log("done");
...
export default ClaimAirdropRefer;
